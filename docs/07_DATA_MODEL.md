...
KudaGo cities/events and normalized DTOs use parameter-specific keys with TTL. They are temporary external cache entries, not domain tables and not backup data in PostgreSQL.
